...
public:
    ...
    FVP_NS_DEF::RenderIndexProxy&  GetRenderIndexProxy(){ return _renderIndexProxy;}
    ...
    SdfPath GetDelegateID(TfToken name) const;

    MayaHydraSceneIndexRefPtr GetSceneIndex() const { return _sceneIndex; }
